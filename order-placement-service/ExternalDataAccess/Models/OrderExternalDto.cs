...
namespace order_placement_service.ExternalDataAccess.Models
{
    public class OrderExternalDto
    {
        ...
        /// </summary>
        public AddressExternalDto BillingAddress { get; set; }

        /// <summary>
        /// Gets or sets the shipping address
        /// </summary>
        public AddressExternalDto ShippingAddress { get; set; }
        ...
        /// </summary>
        public List<OrderItemExternalDto> OrderItems { get; set; }
        ...
        {
            OrderItems = new List<OrderItemExternalDto>();
