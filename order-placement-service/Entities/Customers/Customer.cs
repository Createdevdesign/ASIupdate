...
namespace order_placement_service.Entities.Customers
{
    ...
    public class Customer : BaseEntity
    {
        ...
        /// <summary>
        /// Gets or sets the customer Preferred Notification
        /// </summary>
        public Notification Preference { get; set; }
        //public virtual ICollection<Preference> Preference
        //{
        //    get { return _preferences ?? (_preferences = new List<Preference>()); }
        //    protected set { _preferences = value; }
        //}

        /// <summary>
        /// Property to contain the sessions
        /// </summary>
